...
function ProfileContent({...props}) {
    const { onEditBtnClick,info}=props;
    return (
        ...
        <div id="Profile" className="profile-container">
            <div className="banner">
                ...
                <Button handlebtnClick={onEditBtnClick} btnClass="p-edit-btn p-btn" id="p-edit-btn">
                    <Icon
                ...
                <div className="profile-details">
                    ...
                    <div className="profile-buttons">
                        {BUTTON_INFO.map((item) => (
                            <Button key={item.classname} btnClass={`${item.classname} `}>{item.placeholder}</Button>
                        ))
                        }
                    </div>
                </div>
